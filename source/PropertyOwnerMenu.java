...
public class PropertyOwnerMenu {
    ...
    public void run() {
        ...
        if(scan.nextLine().contentEquals("Yes")) {
        	...
        	propOwner = new PropertyOwner(ownerName, address.split(" "), eircode);
        ...
        while(more) {
            ...
            if (command.equals("R")) {
                ...
                owners.registerProperty(propOwner, address.split(" "), eircode, estimatedMarketVal, locCat, ppr);
            	...
            	if(propOwner.getTaxDue() == 0){
            		...
            		while(anotherProp) {
	            		...
	            		if(answer.contentEquals("yes")) {
	            			propOwner.payTax(selectedProp.getBalance(), selectedProp, /*year tax was due?*/);
