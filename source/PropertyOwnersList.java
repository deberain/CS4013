...
public class PropertyOwnersList {
    ...
    public void registerOwner(String name, Address address, String eircode) {
        owners.add(new PropertyOwner(name, address, eircode));
    }
    ...
    public void registerProperty(PropertyOwner owner, String[] address, String eircode, double estMarketValue,String locationCategory, boolean principlePrivateResidence) {
        for (PropertyOwner propowner : owners) {
            if (propowner.equals(owner)) {
                propowner.registerProperty(new Property(propowner, address, eircode, estMarketValue, locationCategory, principlePrivateResidence));
            }
        }
    }
